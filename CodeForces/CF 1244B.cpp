...
void solve(int tc)
{
    ...
    if(s[0]=='1' || s[n-1]=='1'){
        ...
        int ones = 0, first_one = -1, last_one = -1;
        ...
        int sum = 0, first_max = 0, second_max = 0;
        if(first_one!=-1 && last_one!=-1){
            first_max = max(first_one + 1, n - first_one) * 2;
            second_max = max(last_one + 1, n - last_one) * 2;
        }
        else if(first_one != -1) first_max = max(first_one + 1, n - first_one) * 2;

        ans = max3(n+ones, first_max, second_max);
    }
