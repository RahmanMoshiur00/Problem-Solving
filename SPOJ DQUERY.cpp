...
-->To apply Moâ��s algorithm, you must ensure of three properties:
...
#define mxn           30010 // max size of the input array
...
void solve(int tc)
{
    ...
    */
    ...
    int n, q, l, r;
    scanf("%lld", &n); // n: number of elements, q: number of query
