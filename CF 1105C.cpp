...
#define sfi2(a,b)       scanf("%lld %lld", &a, &b)
#define sfi3(a, b, c)   scanf("%lld %lld %lld", &a, &b, &c)
...
#define pfi2(a,b)       printf("%lld %lld", (intl)a, (intl)b)
#define pfi3(a, b, c)   printf("%lld %lld %lld", (intl)a, (intl)b, (intl)c)
